...
const AdminDashboard = () => {
  ...
  const [activeView, setActiveView] = useState('dashboard'); // 'dashboard' | 'statistics' | 'manage-rooms'
          ...
          {activeView === 'dashboard' ? (
            <>
              ...
              <div style={{ marginTop: '1rem' }}>
                <button className="login-btn" onClick={() => setActiveView('statistics')}>Statistics</button>
                <button className="login-btn" style={{ marginLeft: '10px' }} onClick={() => setActiveView('manage-rooms')}>Manage Rooms</button>
              </div>
            </>
            ...
            <>
              {/* All Classrooms Table (Manage Rooms) */}
              <section className="dashboard-section">
